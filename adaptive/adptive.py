...
class SteganographyApp:
    ...
    def select_data_type(self):
        data_type = simpledialog.askstring("Input", "Enter data type (text or image):")
    ...
    def hide_text_data(self):
        self.hidden_data_path = filedialog.askopenfilename(filetypes=[("Text Files", "*.txt")])
        with open(self.hidden_data_path, "rb") as file:
    ...
    # Method to extract data from the stego image
    def extract_data(self):
        ...
        if is_image:
            ...
            messagebox.showinfo("Extracted Text", original_data.decode())
